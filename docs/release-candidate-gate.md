...
- Date: 2026-07-17
- Automated gate: passed (`npm run test:client-ready`; 155 automated tests and 11 browser tests)
- Live submission proof: passed
- Reported client defects: CLIENT-20260720-01, CLIENT-20260720-02, and CLIENT-20260720-03 ready for deployed retest
- Performance observation: cold-start submission latency remains under monitoring
- Decision: hold until the durable admin-list, SVG classification, and effective-DPI retests pass
